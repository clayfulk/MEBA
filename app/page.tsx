    ...
    <>
      <header className="px-4 lg:px-6 h-14 flex items-center border-b">
        ...
        <nav className="ml-auto flex items-center gap-4 sm:gap-6">
          ...
          <Link className="text-sm font-medium hover:underline underline-offset-4 hidden md:block" href="/chat">
            Chat
          </Link>
          <DropdownMenu>
      ...
      <main className="flex-1">
        <section className="w-full py-8 md:py-12 lg:py-16 xl:py-20 bg-gradient-to-b from-background to-secondary/20">
