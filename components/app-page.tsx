    ...
    <>
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <Link className="flex items-center justify-center" href="#">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/u3686738724_Exclamation_point_logo_Members_Employment_Benefit_926b4998-0afd-4e73-a4ff-2a04d21c47e6_2-MKr8uPn8fAkm9UGo69aHCQhU7xlXlf.png"
            alt="MEBA Logo"
            width={40}
            height={40}
            className="mr-2"
